...
def main():
    ...
    plt.title("Trend of Alien Belief Over Time\n"
    ...
    plt.savefig("plots/alien_claims_ngram_market.png", dpi=300, bbox_inches="tight")
    plt.close()

    print("Saved: plots/alien_claims_ngram_market.png")
